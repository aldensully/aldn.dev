      ...
      <div className='flex flex-col lg:flex-row items-center justify-center'>
        <div className='flex flex-2 w-full justify-center flex-col items-center'>
          ...
          <Link href={'/gameoflife'}>
            <button className='items-center absolute left-[50%] bottom-[10%] translate-x-[-50%] justify-center w-[260px] h-[60px] bg-bg  border-fg rounded-small'>
              <text className='text-text text-sm font-reg'>Game of Life</text>
            </button>
          </Link>
        </div>
      </div>
